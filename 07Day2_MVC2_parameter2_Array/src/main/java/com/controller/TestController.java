...
public class TestController {
	...
	public String login1(LoginDTO dto) {
		System.out.println("LoginDTO dto" + dto);
		return "login";
	}
	...
	public String login3(@RequestParam String userid, @RequestParam String passwd) {
		System.out.println("@RequestParam String userid, @RequestParam String passwd" + userid + "\t" + passwd);
		return "login";
	}
	...
	public String login5(@RequestParam(required = false, defaultValue = "홍길동") String userid, String passwd) {
		System.out.println("/login5 @RequestParam(required = false, defaultValue = \"홍길동\") String userid, String passwd " + userid + "\t" + passwd);
		return "login";
	}
